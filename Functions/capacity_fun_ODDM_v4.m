function capacity_fun_ODDM_v4(conn,EbN0_range,num_frames,parameters)
...
if sum(run_flags) > 0
    ...
    [Ambig_Table.vals,Ambig_Table.t_range,Ambig_Table.f_range] = gen_DD_cross_ambig_table(N,M,T,Fc,vel,shape,alpha_inst,Q,res);
    ...
    for frame = 1:max(new_frames)
        ...
        H = gen_HDD_direct(T,N,M,Fc,vel,Q,Ambig_Table);
